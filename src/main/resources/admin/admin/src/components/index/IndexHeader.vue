<template>
	<div class="navbar">
		<div class="title" :style='{"display":"block","height":"44px"}'>
			...
			<span class="title-name" :style='{"padding":"0 0 0 12px","lineHeight":"44px","fontSize":"26px","color":"#656530","float":"left","fontWeight":"500"}'>{{this.$project.projectName}}</span>
		</div>
		<div class="right" :style='{"fontSize":"16px","position":"absolute","top":"8px","left":"200px","display":"flex"}'>
