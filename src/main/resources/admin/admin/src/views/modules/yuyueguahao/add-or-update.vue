	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="挂号数" prop="guahaoshu">
					<el-select :disabled="ro.guahaoshu" v-model="ruleForm.guahaoshu" placeholder="请选择挂号数" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="挂号数" prop="guahaoshu">
					<el-input v-model="ruleForm.guahaoshu"
						placeholder="挂号数" readonly></el-input>
				</el-form-item>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ro.guahaoshu = false;

				this.ruleForm.guahaoshu='1'
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.guahaoshu = objcross.guahaoshu - this.ruleForm.guahaoshu
	      if(objcross.guahaoshu<0){
