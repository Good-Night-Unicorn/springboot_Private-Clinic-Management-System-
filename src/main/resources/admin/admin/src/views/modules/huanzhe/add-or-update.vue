	...
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px","background":"url(http://codegen.caihongy.cn/20230401/18da3753d22a4199b5abc44dee037d48.png) fixed"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="患者住址" prop="huanzhezhuzhi">
					<el-input v-model="ruleForm.huanzhezhuzhi" placeholder="患者住址" clearable  :readonly="ro.huanzhezhuzhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="患者住址" prop="huanzhezhuzhi">
					<el-input v-model="ruleForm.huanzhezhuzhi" placeholder="患者住址" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='huanzhezhuzhi'){
							this.ruleForm.huanzhezhuzhi = obj[o];
							this.ro.huanzhezhuzhi = true;
							continue;
						}
				}
