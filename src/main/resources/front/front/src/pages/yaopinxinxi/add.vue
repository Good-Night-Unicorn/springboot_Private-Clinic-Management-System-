...
<div :style='{"width":"100%","padding":"20px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="药品图片" v-if="type!='cross' || (type=='cross' && !ro.yaopintupian)" prop="yaopintupian">
            <file-upload
            tip="点击上传药品图片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' class="upload" v-else label="药品图片" prop="yaopintupian">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="保质期" prop="baozhiqi">
            <el-input v-model="ruleForm.baozhiqi" 
                placeholder="保质期" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}'  label="剂型" prop="jixing">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="生产厂家" prop="shengchanchangjia">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px 0"}' label="药品说明" prop="yaopinshuoming">
            <editor 
